...
function Login() {
  ...
  return (
    <section className="flex flex-col text-white w-full min-h-screen justify-center items-center px-2">
      <div id="content" className="flex flex-col gap-12 items-center">
        <p id="id" className="text-4xl px-6 py-4 md:text-5xl md:px-12 md:py-8 font-bold break-after-page min-w-fit text-white bg-black rounded-full bg-opacity-10 text-center w-fit">
